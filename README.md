...
* [**动手学机器学习决策树算法**](nju_software/ch-03/动手学机器学习决策树算法.md): [配套代码](nju_software/ch-03/decision_tree.ipynb)
	- [_使用决策树对泰坦尼克号幸存者数据进行分类_](nju_software/ch-03/使用决策树对泰坦尼克号幸存者数据进行分类.md) : [配套代码](titanic/decistion_tree.ipynb)
...
* 快速介绍：[什么是深度学习？](nju_software/ch-14/什么是深度学习？.md)
* [深度学习概述](nju_software/ch-14/深度学习概述.md)
* [神经网络示例](nju_software/ch-14/神经网络示例.md)
	* [配套代码](nju_software/ch-14/nn.ipynb)
...
目录 [**sjtu-hands-on-ml**](sjtu-hands-on-ml) 包含了课件和课后习题。
...
配套代码：[let-us-machine-learning](let-us-machine-learning/README.md)