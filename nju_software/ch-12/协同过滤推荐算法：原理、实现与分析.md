...
- **共同评分电影**：A、B、C  
- **评分向量**：  
  - 用户 1: [5, 3, 4]，均值 $\bar{r}_1 = \frac{5+3+4}{3} = 4$  
  - 用户 2: [3, 1, 2]，均值 $\bar{r}_2 = \frac{3+1+2}{3} = 2$  
- **差值向量**：  
  - 用户 1: $[5-4, 3-4, 4-4] = [1, -1, 0]$  
  - 用户 2: $[3-2, 1-2, 2-2] = [1, -1, 0]$  
- **内积**：  
  $$
  (1)(1) + (-1)(-1) + (0)(0) = 1 + 1 + 0 = 2
  $$  
- **分母**：  
  $$
  \sqrt{1^2 + (-1)^2 + 0^2} \times \sqrt{1^2 + (-1)^2 + 0^2} = \sqrt{2} \times \sqrt{2} = 2
  $$  
- **相似度**：  
  $$
  w_{12} = \frac{2}{2} = 1.0
...
- **共同评分电影**：A、B、C  
- **评分向量**：  
  - 用户 1: [5, 3, 4]，均值 $\bar{r}_1 = 4$  
  - 用户 3: [4, 3, 4]，均值 $\bar{r}_3 = \frac{4+3+4}{3} \approx 3.67$  
- **差值向量**：  
  - 用户 1: $[1, -1, 0]$  
  - 用户 3: $[4-3.67, 3-3.67, 4-3.67] \approx [0.33, -0.67, 0.33]$  
- **内积**：  
  $$
...
- **分母**：  
  $$
  \sqrt{1^2 + (-1)^2 + 0^2} \times \sqrt{0.33^2 + (-0.67)^2 + 0.33^2} = \sqrt{2} \times \sqrt{0.11 + 0.45 + 0.11} \approx 1.41 \times 0.82 \approx 1.16
  $$  
- **相似度**：  
  $$
  w_{13} = \frac{1.0}{1.16} \approx 0.86
  $$
...
- **评分向量**：  
  - 用户 1: [5, 3, 4]，均值 $\bar{r}_1 = 4$  
  - 用户 4: [3, 3, 1]，均值 $\bar{r}_4 = \frac{3+3+1}{3} \approx 2.33$  
- **差值向量**：  
  - 用户 1: $[1, -1, 0]$  
  - 用户 4: $[3-2.33, 3-2.33, 1-2.33] \approx [0.67, 0.67, -1.33]$  
- **内积**：  
  $$
...
预测评分 $\hat{r}_{1D} ≈ 4.23$，意味着用户 1 很可能喜欢电影 D（高于自身的平均分 `4.0`），因此可以作为推荐项。
